...
capital = ask_float("Capital principal: ")
interes = ask_float("Interés anual: ")/100
years = ask_int("Años de imposición: ")
periodo = ask_int("Periodos de imposición anual: ")

final = capital *(1 + interes/periodo)**(periodo * years)

print("{:.2f} € invertidos al {:.2f}% durante {} años con {} periodos de imposición por año se transforman en {:.2f} €".format(capital, interes*100, years, periodo, final))

# Resto 2:
final = ask_float("Suma total a conseguir: ")
interes = ask_float("Interés anual: ")/100
years = ask_int("Años de imposición: ")
periodo = ask_int("Periodos de imposición anual: ")

capital = final / (1 + interes/periodo)**(periodo * years)

print("Capital inicial a invertir es de {:.2f}€ al {:.2f}% durante {} años con {} periodos de imposición para conseguir una suma total de {:.2f}€".format(capital, interes*100, years, periodo, final))